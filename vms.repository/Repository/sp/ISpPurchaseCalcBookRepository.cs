...
public interface ISpPurchaseCalcBookRepository
{
	...
	Task<List<SpPurchaseSaleCalcBook>> GetSpPurchaseSaleCalcBook(int organizationId, DateTime fromDate, DateTime toDate,
		int customerId, int vendorId, int productId);
