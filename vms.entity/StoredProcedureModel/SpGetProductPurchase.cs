...
public class SpGetProductPurchase
{
	...
	public decimal? RebatablePurchaseVat { get; set; }
	public decimal? RebatableReturnVat { get; set; }
	public decimal? RebatableVatAmount { get; set; }
