...
public class VmExcelSimplifiedSales
{
    ...
    [MaxLength(50, ErrorMessage = "The 'SalseType'  {1} characters long.")]
    public string SalesType { get; set; }
    [MaxLength(50, ErrorMessage = "The 'ExportType'  {1} characters long.")]
    ...
    [Range(0.00, 9999999999999999.99, ErrorMessage = "VdsAmount must be greater than 0.00")]
    public decimal VdsAmount { get; set; }
    public bool? IsTds { get; set; }
    [Range(0.00, 9999999999999999.99, ErrorMessage = "TdsAmount must be greater than 0.00")]
    public decimal TdsAmount { get; set; }
    [MaxLength(100, ErrorMessage = "The 'PaymentReceiveId'  {1} characters long.")]
    public string PaymentReceiveId { get; set; }
    [MaxLength(50, ErrorMessage = "The 'PaymentReceiveMethod'  {1} characters long.")]
    ...
    [Range(0.00, 9999999999999999.99, ErrorMessage = "PaymentReceiveAmount must be greater than 0.00")]
