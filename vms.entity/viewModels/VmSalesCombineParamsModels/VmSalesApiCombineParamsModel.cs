...
public class VmSalesApiCombineParamsModel
{
	public List<VmSaleApiDetailCombineParamsModel> SalesDetailList { get; set; } = new List<VmSaleApiDetailCombineParamsModel>();
	public List<VmSaleApiContentCombineParamsModel> ContentInfoJson { get; set; } = new List<VmSaleApiContentCombineParamsModel>();
	public List<VmSaleApiPaymentReceiveCombineParamsModel> SalesPaymentReceiveJson { get; set; } = new List<VmSaleApiPaymentReceiveCombineParamsModel>();
