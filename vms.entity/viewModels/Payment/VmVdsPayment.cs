...
public class VmMushakReturnPaymentForVds
{
...
public class VmVdsPaymentPost
{
    public VmVdsPaymentPost()
    {
        paymentForVdsList = new List<VmMushakReturnPaymentForVds>();
    }
    ...
    [Required]
    public int BankBranchDistrictOrCityId { get; set; }
    public IEnumerable<VmMushakReturnPaymentForVds> paymentForVdsList { get; set; }
    [Range(minimum: 2000, maximum: 2050, ErrorMessage = "Value Must be Between 2021 and 2050")]
    [Required(ErrorMessage = "Year is Required")]
    public int Year { get; set; }
    [Required(ErrorMessage = "Month is Required")]
    ...
    public SelectList PaymentTypes;
    public IEnumerable<CustomSelectListItem> BankList;
