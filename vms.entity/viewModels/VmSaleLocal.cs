...
public class VmSaleLocal : VmSaleLocalBase
{
    public VmSaleLocal()
    {
        ...
        ViewOrganizationConfigurationBooleanData = new List<ViewOrganizationConfigurationBoolean>();
    }
    ...
    public IEnumerable<ViewOrganizationConfigurationBoolean> ViewOrganizationConfigurationBooleanData { get; set; }
    ...
    // [Required(ErrorMessage = "PO No. is Reuied")]
    [DisplayName("PO No.")]
    [MaxLength(20)]
