...
public class BranchTransferReceiveParamViewModel
{
	public BranchTransferReceiveParamViewModel()
	{
		Products = new List<BranchTransferReceiveProductParamViewModel>();
		Documents = new List<BranchTransferReceiveContentParamsViewModel>();
	}
	...
	public IEnumerable<BranchTransferReceiveProductParamViewModel> Products { get; set; }
	public IEnumerable<BranchTransferReceiveContentParamsViewModel> Documents { get; set; }
}