...
public class BranchTransferReceiveCreatePostViewModel
{
    public BranchTransferReceiveCreatePostViewModel()
    {
        Products = new List<BranchTransferReceiveProductPostViewModel>();
        Documents = new List<BranchTransferReceiveDocumentPostViewModel>();
    }
    ...
    public IEnumerable<BranchTransferReceiveProductPostViewModel> Products { get; set; }
    public IEnumerable<BranchTransferReceiveDocumentPostViewModel> Documents { get; set; }
}