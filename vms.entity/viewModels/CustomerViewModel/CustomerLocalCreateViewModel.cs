...
public class CustomerLocalCreateViewModel
{
	...
	public IEnumerable<CustomSelectListItem> CustomsAndVatCommissionarates { get; set; } = new List<CustomSelectListItem>();
	public IEnumerable<CustomSelectListItem> BusinessNatureList { get; set; } = new List<CustomSelectListItem>();
	public IEnumerable<CustomSelectListItem> BusinessCategoryList { get; set; } = new List<CustomSelectListItem>();
	public IEnumerable<CustomSelectListItem> DocumentTypeSelectList { get; set; } = new List<CustomSelectListItem>();
	public List<CustomerBranchCreateViewModel> CustomerBranchList { get; set; } = new();
