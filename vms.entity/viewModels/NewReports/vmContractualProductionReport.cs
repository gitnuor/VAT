...
public class vmContractualProductionReport
{
    public vmContractualProductionReport()
    {
        contractualProductionList = new List<ContractualProduction>();
    }
    public IEnumerable<ContractualProduction> contractualProductionList { get; set; }
