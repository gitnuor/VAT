...
public class VmCombineDamage
{
    public VmCombineDamage()
    {
        productList = new List<Product>();
        vMDamageType = new List<CustomSelectListItem>();
    }
    //Main Master Page
    ...
    public IEnumerable<CustomSelectListItem> vMDamageType { get; set; }
}


public class VmCombineDamagePost
{
    public VmCombineDamagePost()
    {
        DamageDetailList = new List<VmCombineDamageDetail>();
    }

    public List<VmCombineDamageDetail> DamageDetailList { get; set; }
    //Main Master Page
    public int DamageTypeId { get; set; }
    public string VoucherNo { get; set; }
    public string Description { get; set; }
...
public class VmCombineDamageDetail
{
    public int MeasurementUnitId { get; set; }
    public int ProductId { get; set; }
    public decimal DamageQty { get; set; }
