...
public class vmProduct
{
    ...
    [DisplayName("Product Vat Type")]
    public int ProductVattypeId { get; set; }
    [Required(ErrorMessage = "Default VAT Percent is required")]
    [DisplayName("Default VAT Percent")]
    [Range(0.00,5000.00,ErrorMessage ="VAT percent must be between 0.00 to 5000.00")]
    public decimal ProductDefaultVatPercent { get; set; }


    public IEnumerable<ProductVattype> ProductVatTypeList { get; set; } = new List<ProductVattype>();
