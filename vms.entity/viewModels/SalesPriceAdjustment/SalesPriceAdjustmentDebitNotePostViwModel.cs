...
public class SalesPriceAdjustmentDebitNotePostViwModel
{
    public SalesPriceAdjustmentDebitNotePostViwModel()
    {
        DetailList = new List<SalesPriceAdjustmentDebitNoteDetailViewModel>();
    }
	...
	public List<SalesPriceAdjustmentDebitNoteDetailViewModel> DetailList { get; set; }
