...
public class PurchaseForeignController : ControllerBase
{
    ...
    public PurchaseForeignController(ISalesDetailService salesDetailService,
    ...
    {
	    var purc = await _purchaseService.GetPurchaseImportListByOrganization(UserSession.ProtectedOrganizationId);

		return View(await _purchaseService.GetPurchaseImportListByOrganization(UserSession.ProtectedOrganizationId));
    }
    ...
    public async Task<IActionResult> Details(string id)
    {
        ...
        return View(ControllerStaticData.DETAIL_IS_NEW, vm);
    }
    ...
    {
        var purchaseDue = await _purchaseOrderService.GetPurchaseDue(UserSession.OrganizationId);
