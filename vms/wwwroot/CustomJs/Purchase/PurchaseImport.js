...
const commonUtilityPurchase = {
    ...
    getTotalTaxByType: (typeId) => {
        ...
        if (typeId === listInfo.taxPaymentType.combined) {
            return commonUtilityPurchase.getTotalCd() +
...
//Payment method change
elementInformation.taxPaymentField.drpPurchaseImportTaxPaymentTypeId.addEventListener('change',
    (event) => {
        const paymentTypeId = +elementInformation.taxPaymentField.drpPurchaseImportTaxPaymentTypeId.value;
        elementInformation.taxPaymentField.txtPurchaseImportTaxPaymentPaidAmount.value =
            commonUtilityPurchase.getTotalTaxByType(paymentTypeId);
    });
...
//            console.log(commonUtilityPurchase.getTotalTaxByType(paymentTypeId));
