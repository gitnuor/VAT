...
const dataAttributes = {
    product: {
        salesDetailId: 'data-Sales-Detail-Id',
...
const commonUtilityDamage = {
    ...
    getFormData: () => {
        ...
        listInfo.products.forEach(d => {
            ...
            formData.append(`SalesId`, elementInformation.mainFormFields.hdnSalesId.value);
            ...
            formData.append(`DamageDetailList[${productIndex}].SalesDetailId`, d.salesDetailId);
