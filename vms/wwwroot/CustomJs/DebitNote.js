...
const commonUtilityCreditNote = {
    ...
    getFormData: () => {
        ...
        listInfo.products.forEach(d => {
            ...
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ProductId`, d.productId);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].MeasurementUnitId`, d.measurementUnitId);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].Quantity`, d.quantity);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].UnitPrice`, d.unitPrice);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].Amount`, d.amount);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].VatParcent`, d.vatParcent);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].Vat`, d.vat);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].SdParcent`, d.sdParcent);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].Sd`, d.sd);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnQuantity`, d.returnQuantity);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnUnitPrice`, d.returnUnitPrice);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnAmount`, d.returnAmount);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnVatParcent`, d.returnVatParcent);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnVat`, d.returnVat);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnSdParcent`, d.returnSdParcent);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReturnSd`, d.returnSd);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].ReasonOfReturnInDetail`, d.reasonOfReturn);
            formData.append(`vmPurchaseDebitNoteDetials[${productIndex}].PurchaseDetailId`, d.purchaseDetailId);
